 ...
 * @description 退货入库调拨单
 */
public class RestockInStorageBillDTO {
    /**
     * 单号
     */
     ...
     * 退货入库调拨单明细
     */
    private List<RestockInStorageBillDetailDTO> billDetailDTOList;
    ...
    public List<RestockInStorageBillDetailDTO> getBillDetailDTOList() {
        return billDetailDTOList;
    }

    public void setBillDetailDTOList(List<RestockInStorageBillDetailDTO> billDetailDTOList) {
