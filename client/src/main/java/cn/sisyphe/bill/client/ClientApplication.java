package cn.sisyphe.bill.client;

import cn.sisyphe.bill.core.domain.base.AbstractBillService;
import cn.sisyphe.bill.core.domain.base.BillServiceFactory;
import cn.sisyphe.bill.core.domain.base.behavior.SaveBehavior;
import cn.sisyphe.bill.core.domain.base.model.BillFactory;
import cn.sisyphe.bill.core.domain.base.model.enums.BillPurposeEnum;
import cn.sisyphe.bill.core.domain.base.model.enums.BillTypeEnum;
import cn.sisyphe.bill.core.domain.base.model.location.Station;
import cn.sisyphe.bill.core.domain.delivery.purchase.PurchaseBill;
import cn.sisyphe.bill.core.domain.delivery.purchase.PurchaseBillDetail;
import cn.sisyphe.bill.core.infrastructure.purchase.PurchaseBillRepository;
...
@ComponentScan(basePackages = {"cn.sisyphe.bill"})
